...
- 各部の中核図のプレースホルダ（本文中の `<!-- fig-… -->` コメント）は配置済み: fig-1-1 / fig-1-2 / fig-2-1 / fig-2-2 / fig-3-1 / fig-4-1 / fig-7-1 / fig-8-1 / fig-11-1 / fig-15-1 / fig-15-2 / fig-18-1 / fig-19-1 / fig-24-1 / fig-26-1 / fig-28-1 / fig-29-1 / fig-32-1 / fig-37-1。残りの図版は、本計画に沿って該当節の直後にプレースホルダと図を追加する。
