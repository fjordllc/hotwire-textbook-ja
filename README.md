...
- [このプロジェクトは何か](#readme-project)
- [ファイル構成](#readme-files)
- [本の全体構成](#readme-structure)
- [ブラウザで読む](#readme-browser)
- [編集する](#readme-edit)
- [HTML を生成する](#readme-html)
- [Cloudflare Pages で公開する](#readme-deploy)
- [品質方針](#readme-policy)
- [ライセンス](#readme-license)
...
2. **[第2部 ハンズオンの準備](./manuscript/part2/index.md)** - Rails サンプルアプリの土台
3. **[第3部 Turbo Drive](./manuscript/part3/index.md)** - ページ遷移とフォーム送信
4. **[第4部 Turbo Frames](./manuscript/part4/index.md)** - 画面分割と独立したナビゲーション
5. **[第5部 Turbo Streams](./manuscript/part5/index.md)** - 部分更新とリアルタイム更新
6. **[第6部 Stimulus](./manuscript/part6/index.md)** - 少量の JavaScript で振る舞いを足す
7. **[第7部 実務で使う Hotwire UI パターン](./manuscript/part7/index.md)** - 検索、モーダル、フォーム UX
8. **[第8部 Hotwire アプリを保守する](./manuscript/part8/index.md)** - テスト、デバッグ、性能、セキュリティ
9. **[第9部 Hotwire Native](./manuscript/part9/index.md)** - Web-first なモバイル展開
10. **[第10部 Hotwire を選ぶべきか](./manuscript/part10/index.md)** - アンチパターン、SPA との使い分け、未来

詳細な各節の内容は [`OUTLINE.md`](./OUTLINE.md) を参照してください。

<a id="readme-browser"></a>
## ブラウザで読む
