...
本書では、思想や生まれた背景を扱いながら、Tailwind CSS 本よりもハンズオンを多くします。1 つの Rails サンプルアプリを作り、通常の CRUD から Turbo Drive、Turbo Frames、Turbo Streams、Stimulus、Hotwire Native へ段階的に広げていきます。
