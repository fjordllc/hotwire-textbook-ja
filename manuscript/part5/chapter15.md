...
<!-- fig-15-1: Turbo Streams のレスポンスと DOM 更新。turbo-stream の action・target・template の構造と、それが対象 id の DOM をどう操作するかを示す構造図 -->
...
<!-- fig-15-2: 8 つのアクションの図解。append/prepend/replace/update/remove/before/after/refresh が対象要素に与える効果を、ビフォー/アフターで並べた比較図 -->
