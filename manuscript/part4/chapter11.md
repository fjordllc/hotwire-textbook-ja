...
![Turbo Frame の id 一致。frame 内リンクが、レスポンスから同じ id の turbo-frame だけを抽出して差し替える仕組みと、id 不一致時の Content missing を示す構造図](../figures/fig-11-1.svg)
...
![既定、自分以外の frame、_top での差し替え先の違いを示す図。](../figures/fig-11-2.svg)
