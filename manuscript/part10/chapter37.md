...
![Hotwire と SPA の比較軸。描画・状態・通信・JavaScript 量の 4 軸上で両者の位置を対比し、SSR メタフレームワークで境界がぼやけることも示すスペクトラム図](../figures/fig-37-1.svg)
...
![CRUD 中心か、クライアント状態、オフライン、チーム、API 要否の問いから、Hotwire 向きか SPA/混在向きかを導く図。](../figures/fig-37-2.svg)
